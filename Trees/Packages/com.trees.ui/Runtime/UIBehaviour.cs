...
namespace UI
{
    ...
    public abstract class UIBehaviour : MonoBehaviour
    {
        ...
        protected virtual void OnDisable()
        {
            ...
            if (UIEngine.panel.visualTree.Contains(root))
            {
                UIEngine.panel.visualTree.Remove(root);
                UIRendering.repaint = false;
            }
        }
        ...
        public Rect GetRect()
        {
            ...
            Vector2 offset = new(UIRendering.panelResolution.x * 0.5f, UIRendering.panelResolution.y * 0.5f);
