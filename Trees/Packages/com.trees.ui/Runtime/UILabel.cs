...
namespace UI
{
    public class UILabel : HUDComponent<Label>
    {
        ...
        protected override void UpdateGUI(Label label)
        {
            ...
            label.text = content.Evaluate(ScriptingLibrary.interpreter);
            label.style.color = color.Evaluate(ScriptingLibrary.interpreter);
            label.style.fontSize = fontSize.Evaluate(ScriptingLibrary.interpreter);
